...
export default {
  ...
  methods: {
    init() {
      ...
      let circleMat = new _self.$THREE.MeshBasicMaterial({ color: 0xffca05 });
      _self.models.sun = new _self.$THREE.Mesh(circleGeo, circleMat);
      _self.models.sun.position.x = 0;
      _self.models.sun.position.y = 100;
      _self.models.sun.position.z = -500;
      _self.models.sun.scale.setX(1.2);
      _self.scene.add(_self.models.sun);
    ...
    animate() {
      ...
      _self.models.sun.position.y = _self.mousePosition.y * 10 + 100;
      _self.models.sun.position.x = _self.mousePosition.x * 10;
